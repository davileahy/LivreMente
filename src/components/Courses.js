...
const coursesData = [
  {
    ...
    categories: ['Idiomas', 'Inglês', 'Interativo', 'Gratuito', 'Iniciantes', 'Interativo', 'Gameficado'],
  ...
  },
  {
    ...
    description: 'O Memrise é uma plataforma de aprendizado de idiomas que utiliza um algoritmo baseado na ciência cognitiva para ajudar os usuários a aprender de forma mais rápida e eficaz.',
  ...
  },
  {
    title: 'Busuu',
    logo: logo_busuu,
    description: 'O Busuu é uma plataforma online de aprendizado de idiomas que permite aos usuários interagir com falantes nativos. Ela oferece cursos em 14 idiomas diferentes, desde o nível iniciante até o avançado.',
    categories: ['Idiomas', 'Gratuito', 'Iniciantes', 'Itermediário', 'Avançado', 'Interativo' ],
    link: 'https://www.busuu.com/pt',
  },
  {
    title: 'Tandem',
    logo: logo_tandem,
    description: 'Plataforma de intercâmbio de idiomas onde você conversa com falantes nativos de outros idiomas por meio de chamadas de vídeo ou texto, oferecendo um aprendizado mais prático.',
  ...
  },
  {
    title: 'LingQ',
    logo: logo_lingq,
    description: 'Plataforma que utiliza textos e áudios reais, como livros, artigos e vídeos, para ensinar idiomas, focando no aprendizado por meio da imersão em conteúdo autêntico.',
  ...
  },
  {
    title: 'Anki',
    logo: logo_anki,
    description: 'Software de repetição espaçada para criar flashcards personalizados, utilizado por muitos estudantes para memorização eficaz de palavras e frases em vários idiomas.',
  ...
  },
  {
    title: 'Future Learn',
    logo: logo_fl,
    description: 'Plataforma de cursos online que oferece lições de idiomas de universidades e instituições renomadas. A maioria dos cursos é gratuita, com funcionalidades extras opcionais.',
        ...
        <Box className="p-10 bg-gray-100">
            ...
            <Heading as='h2' className='text-center mb-5'>
                ...
                <Text fontSize='xl' fontWeight='light'>
                    Nossa seleção de plataformas de cursos para impulsionar o seu aprendizado.
                </Text>
