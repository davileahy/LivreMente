    ...
    return (
        ...
        <VStack spacing={10} align="start">
            ...
            <Text fontSize="lg" color="#34495E">
                Este projeto tem como objetivo proporcionar acesso a plataformas gratuitas para o aprendizado de idiomas, especialmente o inglês. Nossa missão é democratizar o aprendizado e facilitar a educação de qualidade para todos.
            </Text>
            </Box>
            ...
            <Box bg="white" p={6} borderRadius="md" boxShadow="lg">
            <Heading as="h2" size="lg" mb={4} color="#2980B9">Desenvolvimento</Heading>
            <Stack spacing={4}>
